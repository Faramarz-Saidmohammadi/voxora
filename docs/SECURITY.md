...
- Production provider credentials require project-level spend limits, expiration, monitoring, and rotation.
...
- Provider calls use bounded timeouts and retries; client cancellation propagates to the SDK request
